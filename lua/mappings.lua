...
vim.keymap.set('n', '<C-H><S-H>', ':vertical resize -4<CR>')
vim.keymap.set('n', '<C-L><S-L>', ':vertical resize +4<CR>')
vim.keymap.set('n', '<C-K><S-K>', ':resize +4<CR>')
vim.keymap.set('n', '<C-J><S-J>', ':resize -4<CR>')
